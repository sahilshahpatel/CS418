...
function animate(currentTime) {
  ...
  particles.forEach(particle => {
        ...
        let r = glMatrix.vec3.fromValues(particle.r, particle.r, particle.r);

        glMatrix.mat4.fromTranslation(modelMatrix, particle.pos);
        glMatrix.mat4.scale(modelMatrix, modelMatrix, r);
        ...
        setMaterialUniforms(particle.c, particle.c, kSpecular, shininess);
